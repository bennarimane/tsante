...
?></h3>
 ...
 ?> <span class="badge badge-danger badge-counter">           <?php echo $rows;
		...
		<h2 style="text-align: center">Bienvenue sur votre page 
			<?php     if(isset($_SESSION['pseudo'])){
                  if($_SESSION['role']=='admin'){
                  	                   echo '<li><a href="ad/charts.php"><i style=\"color:green\"><i class=\"icon fa fa-user\" aria-hidden=\"true\" style=\"color:green\"></i>Partie admin</a></li>';
