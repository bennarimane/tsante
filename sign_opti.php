...
$longueurKey = 15;
 ...
 $query=mysqli_query($connexion,"INSERT INTO personne VALUES('','$username','$userphone','$mail','$password','$fileupload','0','$fileupl','opticien','$key','')");
            ...
            <div class="row">
              ...
              <div class="input-wrap">
                ...
                <div class="input-field">
                  ...
                  <input   placeholder="Votre phone"  maxlength="255" pattern="[0-9]{9,}" id="phone"   type="text" name="userphone" />
                </div>
              </div>
            </div>
             <div class="row">
 ...
 <label for="image" > Capture diplôme<span style="color: red">*</span></label>
   ...
   <input type="text" placeholder="0000" name="captcha" />
            ...
            <div class="row last">
              ...
              <a href="opti/login.php">se connecter</a>
          </div>
        </div>
      </form>
    </div>
