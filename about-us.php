...
<body>
   ...
   <?php include "include/template/header.php" ?>
    ...
    <section class="breadcumb-area bg-img gradient-background-overlay" style="background-image: url(include/layout/img/bg-img/hero2.jpg);">
        <div class="container h-100">
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <!-- Title -->
                        <h3 class="breadcumb-title">À PROPOS DE NOUS</h3>
                        <!-- Breadcumb -->
            ...
            <div class="row align-items-center">
                ...
                <div class="col-12 col-lg-5">
                    <div class="medica-about-thumbnail">
                        <img src="include/layout/img/bg-img/about1.png" alt="">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-doctor-area wow fadeInUp" data-wow-delay="0.2s">
                        <div class="doctor-thumbnail">
                            <img src="include/layout/img/bg-img/d1.jpg" alt="">
                        </div>
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-doctor-area wow fadeInUp" data-wow-delay="0.4s">
                        <div class="doctor-thumbnail">
                            <img src="include/layout/img/bg-img/d2.jpg" alt="">
                        </div>
                        <div class="doctor-meta">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-doctor-area wow fadeInUp" data-wow-delay="0.6s">
                        <div class="doctor-thumbnail">
                            <img src="include/layout/img/bg-img/d3.jpg" alt="">
                        </div>
                        <div class="doctor-meta">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-doctor-area wow fadeInUp" data-wow-delay="0.8s">
                        <div class="doctor-thumbnail">
                            <img src="include/layout/img/bg-img/d4.jpg" alt="">
                        </div>
                        <div class="doctor-meta">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-doctor-area wow fadeInUp" data-wow-delay="0.2s">
                        <div class="doctor-thumbnail">
                            <img src="include/layout/img/bg-img/d5.jpg" alt="">
                        </div>
                        <div class="doctor-meta">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-doctor-area wow fadeInUp" data-wow-delay="0.4s">
                        <div class="doctor-thumbnail">
                            <img src="include/layout/img/bg-img/d6.jpg" alt="">
                        </div>
                        <div class="doctor-meta">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-doctor-area wow fadeInUp" data-wow-delay="0.6s">
                        <div class="doctor-thumbnail">
                            <img src="include/layout/img/bg-img/d7.jpg" alt="">
                        </div>
                        <div class="doctor-meta">
                ...
                <div class="col-12 col-sm-6 col-lg-3">
                    <div class="single-doctor-area wow fadeInUp" data-wow-delay="0.8s">
                        <div class="doctor-thumbnail">
                            <img src="include/layout/img/bg-img/d8.jpg" alt="">
                        </div>
                        <div class="doctor-meta">
    ...
    <section class="medica-department-area section_padding_100_0">
        <div class="container">
            <div class="row">
                <div class="col-12">
                    <div class="section_heading">
                        <img src="include/layout/img/icons/molecule.png" alt="">
                        <h2>Our Services</h2>
                        <p>Phasellus at nunc orcidonec ipsum metus, pharetra quis nunc sit amet</p>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/scanner.png" alt="">
                        <h6>Radiology</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/cardiogram.png" alt="">
                        <h6>Cardiology</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/blood-donation.png" alt="">
                        <h6>ENT</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/stomach.png" alt="">
                        <h6>Gastroenterology</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/head.png" alt="">
                        <h6>Neurology</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/lungs.png" alt="">
                        <h6>General surgery</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/microscope.png" alt="">
                        <h6>Haematology</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/mortar.png" alt="">
                        <h6>Nutrition</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/ribbon.png" alt="">
                        <h6>Obstetrics</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                ...
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/stretcher.png" alt="">
                        <h6>Physiotherapy</h6>
                    </div>
                </div>
                <div class="col-12 col-sm-4 col-md-3 col-lg-2">
                    <div class="single-department-area text-center">
                        <img src="include/layout/img/icons/injection.png" alt="">
                        <h6>Urology</h6>
                    </div>
                </div>
            </div>
