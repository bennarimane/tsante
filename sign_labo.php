...
$password=md5($_POST['password']);
 ...
 $query=mysqli_query($connexion,"INSERT INTO personne VALUES('','$username','$userphone','$mail','$password','$fileupload','0','$fileupl','laboratoire','$key','')");
 ...
 <label for="image" > Capture diplôme<span style="color: red">*</span></label>
   ...
   <input type="text" placeholder="0000" name="captcha" />
            ...
            <div class="row last">
              ...
              <a href="labo/login.php">se connecter</a>
          </div>
        </div>
      </form>
    </div>
