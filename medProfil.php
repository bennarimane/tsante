...
$result = mysqli_query($connexion," SELECT personne.id as id, nom ,email,num_tlfn,adresse,jour,h_ov,h_f ,presentation,prix FROM personne,info_medecin,medecin where  personne.id =info_medecin.id_med AND medecin.id=personne.id  AND nom='$var' "); 
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="profile-img">
                            <img src="include/layout/img/d.jpg" alt=""/>
...
?>
                                    ...
                                    <p class="proile-rating">Prix de consultaion: <span><?php  echo $medecin["prix"];
                                    ?></span></p>
