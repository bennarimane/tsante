            ...
            <form method="post">
                <div class="row">
                    <div class="col-md-4">
                      ...
                      <?php echo "<img src=includes/opt/".$opti["avatar"].">\n";?>
